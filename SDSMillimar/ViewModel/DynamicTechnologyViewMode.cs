...
{
    public class DynamicTechnologyViewMode:BaseViewModel
    {
        private readonly DynamicTechnologyRepository repo = null;
        ...
        private TechnologyParam selectedData;
        public TechnologyParam SelectedData
        {
            get => selectedData;
            set
            {
        ...
        public DynamicTechnologyViewMode()
        {
            ...
            repo = new DynamicTechnologyRepository();
        }
        ...
        {
            var view = new DynamicTechnologyDetailControl(null);
            Dialog.Show(view, DialogTokens.DynamicTechnologyView);
        }
        ...
        {
            var view = new DynamicTechnologyDetailControl(SelectedData);
            Dialog.Show(view, DialogTokens.DynamicTechnologyView);
        }
